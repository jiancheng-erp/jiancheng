...
proj_path="/home/desktop99/Desktop/jiancheng" 
server_path="/home/desktop99/Desktop/imgserver"
...
tmux send-keys -t session:0.1 "cd $proj_path/backend-python && gunicorn --bind localhost:8000 --timeout 60 wsgi:app --access-logfile - --error-logfile - 2>&1 | tee -a app.log" C-m
tmux split-window -d
