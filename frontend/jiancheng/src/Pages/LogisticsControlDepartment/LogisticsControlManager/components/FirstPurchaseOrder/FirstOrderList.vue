<template><el-row :gutter="0">
    ...
    <el-row class="u-mt-5" :gutter="20">
        <el-col :span="24">
            <el-table class="u-h-200" :data="$props.pendingTaskData" @row-click="handleRowClick"
    ...
    <el-row class="u-mt-5" :gutter="20">
        <el-col :span="24">
            <el-table class="u-h-200" :data="$props.inProgressTaskData" @row-click="handleRowClick"
                v-loading="datafinished">
                <el-table-column prop="taskName" label="任务名称"></el-table-column>
                <el-table-column prop="orderRId" label="订单号"></el-table-column>
                <el-table-column prop="createTime" label="订单创建时间"></el-table-column>
