<template>
            ...
            <el-tabs v-model="currentTab" type="card" tab-position="top">
                <el-tab-pane label="总采购订单" name="1" height="500">
                    <el-table :data="paginatedFinishedPurchaseOrderData" border stripe height="450">
                        <el-table-column type="expand">
                            <template #default="scope">
                                ...
                                <el-table
                                    :data="scope.row.purchaseDivideOrders"
                                    border
                                    stripe
                                    height="400"
                                >
                                    <el-table-column
                                        prop="purchaseDivideOrderId"
                                        label="采购子订单编号"
                                    ></el-table-column>
                                    <el-table-column
                                        prop="orderRid"
                    ...
                    <el-pagination
                        ...
                        :total="finishedPurchaseOrderData.length"
                        :page-size="pageSize"
                        :current-page="finishedCurrentPage"
                        @current-change="(page) => handlePageChange('finished', page)"
                    ></el-pagination>
                </el-tab-pane>
                <el-tab-pane label="未下发分采购订单" name="0">
                    <el-row :gutter="20">
                        <el-col :span="12" :offset="0">
                            <el-button type="primary" @click="openIssueTotalPurchaseOrderDialog"
                                >下发总采购订单</el-button
                            >
                        </el-col>
                    ...
                    <el-row :gutter="20">
                        <el-col :span="24" :offset="0">
                            <el-table
                                :data="paginatedUnfinishedPurchaseOrderData"
                                border
                                stripe
                                height="450"
                            >
                                ...
                                <el-table-column label="操作">
                                    <template #default="scope">
                                        ...
                                        <el-button
                                            type="success"
                                            @click="handleIssueTotalPurchaseOrder(scope.row)"
                                            >下发</el-button
                                        >
                                    </template>
                                </el-table-column>
                            ...
                            <el-pagination
                                ...
                                background
                                layout="prev, pager, next"
                                :total="unfinishedPurchaseOrderData.length"
                                :page-size="pageSize"
                                :current-page="unfinishedCurrentPage"
                                @current-change="(page) => handlePageChange('unfinished', page)"
                            ></el-pagination>
                        </el-col>
                    </el-row>
                </el-tab-pane>
    ...
    <el-dialog title="下发总采购订单" v-model="isIssueTotalPurchaseOrderDialogVisible" width="60%">
        ...
        <el-row :gutter="20">
            <el-col :span="24" :offset="0">
                <el-table
                    :data="issuePageUnfinishedPurchaseOrderData"
                    border
                    stripe
                    height="600"
        ...
        <template #footer>
            <span>
                ...
                <el-button type="primary" @click="createTotalPurchaseOrder"
                    >下发总采购订单</el-button
                >
            </span>
        </template>
    ...
    <el-dialog title="采购订单详情" v-model="isPurchaseItemDetailDialogVisible" width="80%">
        ...
        <template #footer>
            <span>
                ...
                <el-button type="primary" @click="isPurchaseItemDetailDialogVisible = false"
                    >OK</el-button
                >
            </span>
        </template>
    ...
    >
        ...
        <el-tabs v-if="activeTab !== ''" v-model="activeTab" type="card" tab-position="top">
            <el-tab-pane
                ...
                :key="item.totalPurchaseOrderId"
                :label="item.totalPurchaseOrderRid + '    ' + item.supplierName"
                :name="item.totalPurchaseOrderId"
...
export default {
    ...
    methods: {
        ...
        async submitTotalPurchaseOrder() {
            const res = await axios.post(
                `${this.$apiBaseUrl}/multiissue/submittotalpurchaseorder`,
                {
