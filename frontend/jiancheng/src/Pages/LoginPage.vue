<template>
  <div class="login-page">
    <div class="login-form-container">
      ...
      <el-form :model="loginForm" ref="loginFormRef" :rules="rules" class="login-form" @submit.prevent="handleSubmit">
        ...
        <el-form-item prop="password" class="form-item">
          <el-input type="password" v-model="loginForm.password" autocomplete="off" placeholder="密码" :prefix-icon="Lock"
            class="input-large" />
        </el-form-item>

        <el-button type="primary" native-type="submit" class="button-large">
          登录
        </el-button>
      </el-form>
    </div>
...
.input-large :deep(.el-input__prefix) {
  margin-right: 4px;
}
