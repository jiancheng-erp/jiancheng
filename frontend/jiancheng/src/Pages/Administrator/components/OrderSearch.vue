    ...
    <el-row>
        <el-table :data="orderFilterData" border stripe height="600">
            ...
            <el-table-column label="操作">
                <template #default="scope">
                    <el-button type="primary" size="small" @click="openProductionInstruction(scope.row)">修改指令单</el-button>
                    <el-button type="primary" size="small" @click="openCraftSheet(scope.row)">修改工艺单</el-button>
                    <el-button type="primary" size="small" @click="openFirstBOM(scope.row)">修改一次BOM</el-button>
                    <el-button type="primary" size="small" @click="openSecondBOM(scope.row)">修改二次BOM</el-button>
                    <el-button type="primary" size="small" @click="openFirstPurchase(scope.row)">修改一次采购</el-button>
                    <el-button type="primary" size="small" @click="openSecondPurchase(scope.row)">修改二次采购</el-button>
                </template>
            </el-table-column>
