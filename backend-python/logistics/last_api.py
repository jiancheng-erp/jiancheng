...
@last_api_bp.route("/logistics/getlastinfo", methods=["GET"])
def get_last_info():
    ...
    return jsonify({"lastType": last_type})


@last_api_bp.route("/logistics/searchlastmaterialinfo", methods=["GET"])
...
@last_api_bp.route("/logistics/getlastpurchaseorderitems", methods=["GET"])
