...
def get_bom_details():
    ...
    bom_items = (
        db.session.query(BomItem, Bom, MaterialVariant, Material, MaterialType, Department, Supplier)
    ...
    for bom_item in bom_items:
        item, bom,material_variant, material, material_type, department, supplier = bom_item
        result.append(
            {
